...
execute if score Sec mdataclock matches 60.. run scoreboard players set Sec mdataclock 0
...
execute if score minute2 mdataclock matches 6.. run scoreboard players set minute1 mdataclock 0
execute if score minute2 mdataclock matches 6.. run scoreboard players set minute2 mdataclock 0
execute if score hour1 mdataclock matches 10.. run scoreboard players add hour2 mdataclock 1
execute if score hour1 mdataclock matches 10.. run scoreboard players remove hour1 mdataclock 9
